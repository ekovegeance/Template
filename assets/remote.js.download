...
G:"ytp-mdx-popup-dialog",L:{role:"dialog"},J:[{C:"div",G:"ytp-mdx-popup-dialog-inner-content",J:[{C:"div",G:"ytp-mdx-popup-title",V:"Anda telah logout"},{C:"div",G:"ytp-mdx-popup-description",V:"Video yang Anda tonton dapat ditambahkan ke histori tontonan TV, dan akan memengaruhi rekomendasi konten di TV. Untuk mencegahnya, batalkan dan login ke YouTube di komputer Anda"},{C:"div",G:"ytp-mdx-privacy-popup-buttons",J:[{C:"button",W:["ytp-button","ytp-mdx-privacy-popup-cancel"],V:"Batalkan"},{C:"button",
W:["ytp-button","ytp-mdx-privacy-popup-confirm"],V:"Konfirmasi"}]}]}]});this.l=new g.GQ(this,250);g.B(this,this.l);this.B=this.i["ytp-mdx-privacy-popup-cancel"];this.K(this.B,"click",this.o);this.u=this.i["ytp-mdx-privacy-popup-confirm"];this.K(this.u,"click",this.A)},s9=function(a){g.W.call(this,{C:"div",
...
c=g.T(b,128)?g.UN("Terjadi error pada $RECEIVER_NAME",c):g.WC(b)||g.T(b,4)?g.UN("Diputar di $RECEIVER_NAME",c):g.UN("Terhubung ke $RECEIVER_NAME",c);a.updateValue("statustext",c);a.l.show()}else a.l.hide()},t9=function(a,b){g.rU.call(this,"Diputar di",0,a,b);
...
this.i={key:x6(),name:"Komputer ini"};this.u=null;this.o=[];this.F=this.g=null;this.B=[this.i];this.l=this.i;this.rk=new g.PC(64);this.I=0;this.Wm=-1;if(!g.vz(g.X(this.player))){a=this.player;var b=g.ID(a);b&&(b=b.An())&&(b=new t9(a,b),g.B(this,b));b=new s9(a);g.B(this,b);g.XK(a,b.element,4);this.H=new r9;g.B(this,this.H);g.XK(a,this.H.element,4);this.D=!!$8()}this.A=null},v9=function(a){a.A&&(a.player.removeEventListener("presentingplayerstatechange",a.A),a.A=null)},esa=function(a,b,c){a.rk=c;
...
break;case -1:n9(this,new g.PC(64));break;case -1E3:n9(this,new g.PC(128,{errorCode:"mdx.remoteerror",errorMessage:"Video ini tidak tersedia untuk pemutaran jarak jauh"}))}a=F8(this.g).g;var b=this.B;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.B=a,dsa(this,a));a=F8(this.g);-1==a.volume||Math.round(this.i.getVolume())==a.volume&&this.i.isMuted()==a.muted||this.R.isActive()||this.uB()}else csa(this)};
...
t9.prototype.ze=function(a){return"cast-selector-receiver"==a?"Transmisi...":this.B[a].name};
